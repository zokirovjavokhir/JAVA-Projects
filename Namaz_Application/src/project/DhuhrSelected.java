...
public class DhuhrSelected {
	
	private JFrame DhuhrSelectedFrame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DhuhrSelected window = new DhuhrSelected();
					window.DhuhrSelectedFrame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		DhuhrSelectedFrame = new JFrame();
		DhuhrSelectedFrame.setBounds(100, 100, 600, 600);
		DhuhrSelectedFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		DhuhrSelectedFrame.getContentPane().setLayout(new BorderLayout());
		DhuhrSelectedFrame.setTitle("Namaz Application");
        ...
        takbeerPicture.setIcon(new ImageIcon(DhuhrSelected.class.getResource("/project/wudu/takbir.png")));
        ...
        qoyimPicture.setIcon(new ImageIcon(DhuhrSelected.class.getResource("/project/wudu/qoyim.png")));
        ...
        rukuPicture.setIcon(new ImageIcon(DhuhrSelected.class.getResource("/project/wudu/ruku.png")));
        ...
        qoyim2Picture.setIcon(new ImageIcon(DhuhrSelected.class.getResource("/project/wudu/qoyim1.png")));
        ...
        sujudPicture.setIcon(new ImageIcon(DhuhrSelected.class.getResource("/project/wudu/sajda.png")));
        ...
        sujud2Picture.setIcon(new ImageIcon(DhuhrSelected.class.getResource("/project/wudu/sajda.png")));
        ...
        quoodPicture.setIcon(new ImageIcon(DhuhrSelected.class.getResource("/project/wudu/quood.png")));
        ...
        sujud5Picture.setIcon(new ImageIcon(DhuhrSelected.class.getResource("/project/wudu/sajda.png")));
        ...
        tasleemDesc3Lbl = new JLabel("<html>\n<div style = \"width: 450px;\">\n<p style =  \"margin:10px; background-color: #C0C0C0;\">\n\t<b>Dhuhr Prayer consists of 4 Rakat Sunnah, 4 Rakat Fard and 2 Rakat Sunnah.<b>\n</p>\n</div>\n</html>");
        tasleemDesc3Lbl.setFont(new Font("Times New Roman", Font.PLAIN, 15));
        panel.add(tasleemDesc3Lbl);
        
        goBackBtn = new JButton("Go Back");
        panel.add(goBackBtn);
        DhuhrSelectedFrame.getContentPane().add(scrollPane, BorderLayout.EAST);
	...
	public JFrame getDhuhrSelectedFrame() {
        return DhuhrSelectedFrame;
    }
	private void goBackToPrayerSelectedPage() {
        // Close the current frame
		DhuhrSelectedFrame.dispose();
