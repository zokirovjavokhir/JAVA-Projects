...
public class IshaSelected {

	private JFrame IshaSelectedFrame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					IshaSelected window = new IshaSelected();
					window.IshaSelectedFrame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		IshaSelectedFrame = new JFrame();
		IshaSelectedFrame.setBounds(100, 100, 600, 600);
		IshaSelectedFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		IshaSelectedFrame.getContentPane().setLayout(new BorderLayout());
		IshaSelectedFrame.setTitle("Namaz Application");
        ...
        takbeerPicture.setIcon(new ImageIcon(IshaSelected.class.getResource("/project/wudu/takbir.png")));
        ...
        qoyimPicture.setIcon(new ImageIcon(IshaSelected.class.getResource("/project/wudu/qoyim.png")));
        ...
        rukuPicture.setIcon(new ImageIcon(IshaSelected.class.getResource("/project/wudu/ruku.png")));
        ...
        qoyim2Picture.setIcon(new ImageIcon(IshaSelected.class.getResource("/project/wudu/qoyim1.png")));
        ...
        sujudPicture.setIcon(new ImageIcon(IshaSelected.class.getResource("/project/wudu/sajda.png")));
        ...
        sujud2Picture.setIcon(new ImageIcon(IshaSelected.class.getResource("/project/wudu/sajda.png")));
        ...
        quoodPicture.setIcon(new ImageIcon(IshaSelected.class.getResource("/project/wudu/quood.png")));
        ...
        sujud5Picture.setIcon(new ImageIcon(IshaSelected.class.getResource("/project/wudu/sajda.png")));
        ...
        panel.add(goBackBtn);
        IshaSelectedFrame.getContentPane().add(scrollPane, BorderLayout.EAST);
	...
	public JFrame getIshaSelectedFrame() {
        return IshaSelectedFrame;
    }
	private void goBackToPrayerSelectedPage() {
        // Close the current frame
		IshaSelectedFrame.dispose();
