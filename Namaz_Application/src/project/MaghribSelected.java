...
public class MaghribSelected {

	private JFrame MaghribSelectedFrame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MaghribSelected window = new MaghribSelected();
					window.MaghribSelectedFrame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		MaghribSelectedFrame = new JFrame();
		MaghribSelectedFrame.setBounds(100, 100, 600, 600);
		MaghribSelectedFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		MaghribSelectedFrame.getContentPane().setLayout(new BorderLayout());
		MaghribSelectedFrame.setTitle("Namaz Application");
        ...
        takbeerPicture.setIcon(new ImageIcon(MaghribSelected.class.getResource("/project/wudu/takbir.png")));
        ...
        qoyimPicture.setIcon(new ImageIcon(MaghribSelected.class.getResource("/project/wudu/qoyim.png")));
        ...
        rukuPicture.setIcon(new ImageIcon(MaghribSelected.class.getResource("/project/wudu/ruku.png")));
        ...
        qoyim2Picture.setIcon(new ImageIcon(MaghribSelected.class.getResource("/project/wudu/qoyim1.png")));
        ...
        sujudPicture.setIcon(new ImageIcon(MaghribSelected.class.getResource("/project/wudu/sajda.png")));
        ...
        sujud2Picture.setIcon(new ImageIcon(MaghribSelected.class.getResource("/project/wudu/sajda.png")));
        ...
        quoodPicture.setIcon(new ImageIcon(MaghribSelected.class.getResource("/project/wudu/quood.png")));
        ...
        sujud5Picture.setIcon(new ImageIcon(MaghribSelected.class.getResource("/project/wudu/sajda.png")));
        ...
        tasleemDesc3Lbl = new JLabel("<html>\n<div style = \"width: 450px;\">\n<p style =  \"margin:10px; background-color: #C0C0C0;\">\n\t<b>Maghrib Prayer consists of 3 Rakat Fard and 2 Rakat Sunnah.<b>\n</p>\n</div>\n</html>");
        tasleemDesc3Lbl.setFont(new Font("Times New Roman", Font.PLAIN, 15));
        panel.add(tasleemDesc3Lbl);
        
        goBackBtn = new JButton("Go Back");
        panel.add(goBackBtn);
        MaghribSelectedFrame.getContentPane().add(scrollPane, BorderLayout.EAST);
	...
	public JFrame getMaghribSelectedFrame() {
        return MaghribSelectedFrame;
    }
	private void goBackToPrayerSelectedPage() {
        // Close the current frame
		MaghribSelectedFrame.dispose();
