...
public class WomanAsrSelected {

	private JFrame WomanAsrSelectedFrame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WomanAsrSelected window = new WomanAsrSelected();
					window.WomanAsrSelectedFrame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		WomanAsrSelectedFrame = new JFrame();
		WomanAsrSelectedFrame.setBounds(100, 100, 600, 600);
		WomanAsrSelectedFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		WomanAsrSelectedFrame.getContentPane().setLayout(new BorderLayout());
		WomanAsrSelectedFrame.setTitle("Namaz Application");
        ...
        panel.add(goBackBtn);
        WomanAsrSelectedFrame.getContentPane().add(scrollPane, BorderLayout.EAST);
	...
	public JFrame getWomanAsrSelectedFrame() {
        return WomanAsrSelectedFrame;
    }
	private void goBackToPrayerSelectedPage() {
        // Close the current frame
		WomanAsrSelectedFrame.dispose();
