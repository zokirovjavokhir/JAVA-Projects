...
public class AsrSelected {
	
	private JFrame AsrSelectedFrame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AsrSelected window = new AsrSelected();
					window.AsrSelectedFrame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		AsrSelectedFrame = new JFrame();
		AsrSelectedFrame.setBounds(100, 100, 600, 600);
		AsrSelectedFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		AsrSelectedFrame.getContentPane().setLayout(new BorderLayout());
		AsrSelectedFrame.setTitle("Namaz Application");
        ...
        takbeerPicture.setIcon(new ImageIcon(AsrSelected.class.getResource("/project/wudu/takbir.png")));
        ...
        qoyimPicture.setIcon(new ImageIcon(AsrSelected.class.getResource("/project/wudu/qoyim.png")));
        ...
        rukuPicture.setIcon(new ImageIcon(AsrSelected.class.getResource("/project/wudu/ruku.png")));
        ...
        qoyim2Picture.setIcon(new ImageIcon(AsrSelected.class.getResource("/project/wudu/qoyim1.png")));
        ...
        sujudPicture.setIcon(new ImageIcon(AsrSelected.class.getResource("/project/wudu/sajda.png")));
        ...
        sujud2Picture.setIcon(new ImageIcon(AsrSelected.class.getResource("/project/wudu/sajda.png")));
        ...
        quoodPicture.setIcon(new ImageIcon(AsrSelected.class.getResource("/project/wudu/quood.png")));
        ...
        sujud5Picture.setIcon(new ImageIcon(AsrSelected.class.getResource("/project/wudu/sajda.png")));
	...
	public JFrame getAsrSelectedFrame() {
        return AsrSelectedFrame;
    }
	private void goBackToPrayerSelectedPage() {
        // Close the current frame
		AsrSelectedFrame.dispose();
