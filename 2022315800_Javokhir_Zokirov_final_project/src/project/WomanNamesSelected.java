...
public class WomanNamesSelected {

	private JFrame WomanNamesSelectedFrame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WomanNamesSelected window = new WomanNamesSelected();
					window.WomanNamesSelectedFrame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	 ...
	 */
	public WomanNamesSelected() {
		initialize();
		initializeWomanNamesTable();
	}
	...
	private void initialize() {
		WomanNamesSelectedFrame = new JFrame();
		WomanNamesSelectedFrame.setBounds(100, 100, 600, 600);
		WomanNamesSelectedFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		WomanNamesSelectedFrame.getContentPane().setLayout(null);
		WomanNamesSelectedFrame.setTitle("Namaz Application");
        JScrollPane scrollPane = new JScrollPane();
        scrollPane.setBounds(1, 5, 599, 520);
        WomanNamesSelectedFrame.getContentPane().add(scrollPane);
        ...
        WomanNamesSelectedFrame.getContentPane().add(goBackBtn);
    ...
    private void initializeWomanNamesTable() {
        // Column names
    ...
    public JFrame getWomanNamesSelectedFrame() {
        return WomanNamesSelectedFrame;
    }
    
    private void goBackToWomanSelectedPage() {
        // Close the current frame
    	WomanNamesSelectedFrame.dispose();
