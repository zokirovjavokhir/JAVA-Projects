...
public class WomanIshaSelected {

	private JFrame WomanIshaSelectedFrame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WomanIshaSelected window = new WomanIshaSelected();
					window.WomanIshaSelectedFrame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		WomanIshaSelectedFrame = new JFrame();
		WomanIshaSelectedFrame.setBounds(100, 100, 600, 600);
		WomanIshaSelectedFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		WomanIshaSelectedFrame.getContentPane().setLayout(new BorderLayout());
		WomanIshaSelectedFrame.setTitle("Namaz Application");
        ...
        qoyimPicture.setIcon(new ImageIcon(WomanIshaSelected.class.getResource("/project/wudu/qoyim.png")));
        ...
        panel.add(goBackBtn);
        WomanIshaSelectedFrame.getContentPane().add(scrollPane, BorderLayout.EAST);
	...
	public JFrame getWomanIshaSelectedFrame() {
        return WomanIshaSelectedFrame;
    }
	private void goBackToPrayerSelectedPage() {
        // Close the current frame
		WomanIshaSelectedFrame.dispose();

        // Open the PrayerSelected page
        EventQueue.invokeLater(() -> {
            try {
                WomanPrayerSelected womanPrayerSelectedWindow = new WomanPrayerSelected();
                womanPrayerSelectedWindow.getWomanPrayerSelectedFrame().setVisible(true);
            } catch (Exception e) {
                e.printStackTrace();
            }
        });
