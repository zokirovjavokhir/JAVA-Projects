...
public class WomanFajrSelected {

	private JFrame WomanFajrSelectedFrame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WomanFajrSelected window = new WomanFajrSelected();
					window.WomanFajrSelectedFrame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		WomanFajrSelectedFrame = new JFrame();
		WomanFajrSelectedFrame.setBounds(100, 100, 600, 600);
		WomanFajrSelectedFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		WomanFajrSelectedFrame.getContentPane().setLayout(new BorderLayout());
		WomanFajrSelectedFrame.setTitle("Namaz Application");
        ...
        panel.add(goBackBtn);
        WomanFajrSelectedFrame.getContentPane().add(scrollPane, BorderLayout.EAST);
	...
	public JFrame getWomanFajrSelectedFrame() {
        return WomanFajrSelectedFrame;
    }
	private void goBackToPrayerSelectedPage() {
        // Close the current frame
		WomanFajrSelectedFrame.dispose();
