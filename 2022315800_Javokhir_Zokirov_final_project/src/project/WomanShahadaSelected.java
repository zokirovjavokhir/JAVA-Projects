...
public class WomanShahadaSelected {

	private JFrame WomanShahadaSelectedFrame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WomanShahadaSelected window = new WomanShahadaSelected();
					window.WomanShahadaSelectedFrame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		WomanShahadaSelectedFrame = new JFrame();
		WomanShahadaSelectedFrame.getContentPane().setBackground(new Color(0xA9C7AC));
		WomanShahadaSelectedFrame.setBounds(100, 100, 600, 600);
		WomanShahadaSelectedFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		WomanShahadaSelectedFrame.setTitle("Namaz Application");
		WomanShahadaSelectedFrame.getContentPane().setLayout(null);
		...
		WomanShahadaSelectedFrame.getContentPane().add(mainTextLbl);
		...
		WomanShahadaSelectedFrame.getContentPane().add(subhanallahLbl);
		...
		WomanShahadaSelectedFrame.getContentPane().add(subhanallahLbl1);
		...
		WomanShahadaSelectedFrame.getContentPane().add(alhamdulillahLbl);
		...
		WomanShahadaSelectedFrame.getContentPane().add(alhamdulillahLbl1);
		...
		WomanShahadaSelectedFrame.getContentPane().add(allahuakbarLbl);
		...
		WomanShahadaSelectedFrame.getContentPane().add(allahuakbarLbl1);
		...
		WomanShahadaSelectedFrame.getContentPane().add(footerText);
		
		goBackBtn = new JButton("Go Back");
		goBackBtn.setBounds(6, 537, 117, 29);
		WomanShahadaSelectedFrame.getContentPane().add(goBackBtn);
	...
	public JFrame getWomanShahadaSelectedFrame() {
        return WomanShahadaSelectedFrame;
    }
	private void goBackToWomanDhikrSelectedPage() {
        // Close the current frame
		WomanShahadaSelectedFrame.dispose();
