...
public class WomanMaghribSelected {

	private JFrame WomanMaghribSelectedFrame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WomanMaghribSelected window = new WomanMaghribSelected();
					window.WomanMaghribSelectedFrame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		WomanMaghribSelectedFrame = new JFrame();
		WomanMaghribSelectedFrame.setBounds(100, 100, 600, 600);
		WomanMaghribSelectedFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		WomanMaghribSelectedFrame.getContentPane().setLayout(new BorderLayout());
		WomanMaghribSelectedFrame.setTitle("Namaz Application");
        ...
        panel.add(goBackBtn);
        WomanMaghribSelectedFrame.getContentPane().add(scrollPane, BorderLayout.EAST);
	...
	public JFrame getWomanMaghribSelectedFrame() {
        return WomanMaghribSelectedFrame;
    }
	private void goBackToPrayerSelectedPage() {
        // Close the current frame
		WomanMaghribSelectedFrame.dispose();
