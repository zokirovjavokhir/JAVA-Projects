...
public class WomanWuduSelected {
	
	private JFrame womanWuduFrame;
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					...
					window.womanWuduFrame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		womanWuduFrame = new JFrame();
		womanWuduFrame.setBounds(100, 100, 600, 600);
		womanWuduFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		womanWuduFrame.getContentPane().setLayout(new BorderLayout());
		womanWuduFrame.setTitle("Namaz Application");
		...
		step3Picture.setIcon(new ImageIcon(WuduSelected.class.getResource("/project/wudu/womanHands.png")));
		...
		step4Picture.setIcon(new ImageIcon(WuduSelected.class.getResource("/project/wudu/womanMouth.png")));
		...
		step5Picture.setIcon(new ImageIcon(WuduSelected.class.getResource("/project/wudu/womanNose.png")));
		...
		step6Picture.setIcon(new ImageIcon(WuduSelected.class.getResource("/project/wudu/womanFace.png")));
		...
		step7Picture.setIcon(new ImageIcon(WuduSelected.class.getResource("/project/wudu/womanArm.png")));
		...
		step8Picture.setIcon(new ImageIcon(WuduSelected.class.getResource("/project/wudu/womanHair.png")));
		...
		step9Picture.setIcon(new ImageIcon(WuduSelected.class.getResource("/project/wudu/womanEar.png")));
		...
		step10Picture.setIcon(new ImageIcon(WuduSelected.class.getResource("/project/wudu/womanFeet.png")));
		...
		panel.add(goBackBtn);
        womanWuduFrame.getContentPane().add(scrollPane, BorderLayout.CENTER);
        ...
        public JFrame getWomanWuduFrame() {
            return womanWuduFrame;
        }
        private void goBackToWomanSelectedPage() {
            // Close the current frame
            womanWuduFrame.dispose();

            // Open the WomanSelected page
            EventQueue.invokeLater(() -> {
                try {
                    WomanSelected womanSelected = new WomanSelected();
                    womanSelected.getWomanFrame().setVisible(true);
                } catch (Exception e) {
                    e.printStackTrace();
                }
            });
