...
public class WomanDhuhrSelected {

	private JFrame WomanDhuhrSelectedFrame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					WomanDhuhrSelected window = new WomanDhuhrSelected();
					window.WomanDhuhrSelectedFrame.setVisible(true);
				} catch (Exception e) {
					e.printStackTrace();
				}
			}
	...
	private void initialize() {
		WomanDhuhrSelectedFrame = new JFrame();
		WomanDhuhrSelectedFrame.setBounds(100, 100, 600, 600);
		WomanDhuhrSelectedFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		WomanDhuhrSelectedFrame.getContentPane().setLayout(new BorderLayout());
		WomanDhuhrSelectedFrame.setTitle("Namaz Application");
        ...
        panel.add(goBackBtn);
        WomanDhuhrSelectedFrame.getContentPane().add(scrollPane, BorderLayout.EAST);
	...
	public JFrame getWomanDhuhrSelectedFrame() {
        return WomanDhuhrSelectedFrame;
    }
	private void goBackToPrayerSelectedPage() {
        // Close the current frame
		WomanDhuhrSelectedFrame.dispose();
